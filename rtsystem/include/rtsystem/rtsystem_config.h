...
#define ELEVATOR_STARTUP_TICKS_BETWEEN_FLOORS (3000/ ELEVATOR_TASK_HEARTBEAT_MS) // 3 seconds, approximate time to move between floors (still works if miscalculated)
